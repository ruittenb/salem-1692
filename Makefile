...
.PHONY: build
build: ## Build and serve project
	elm make src/Main.elm --output dist/elm.js

.PHONY: elm-live
elm-live: # Build and serve project; rebuild and reload on changes
	# TypeError [ERR_INVALID_ARG_TYPE]: The "path" argument must be of type string or an instance
	# of Buffer or URL. Received undefined at readFile (fs.js:326:10)
	#elm-live src/Main.elm src/Model.elm --dir=dist --start-page=dist/index.html --hot -- --output=dist/elm.js
