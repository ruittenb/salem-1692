...
function getFilesToCache(debug) {
    ...
    return [
        ...
        'fonts/Alfios.otf',
        'fonts/Alfios-Bold.otf',
        'fonts/Alfios-Italic.otf',
        'fonts/Alfios-BoldItalic.otf',
        ...
        'images/favicon-196-monochrome.png',
        'images/favicon-300.png',
        'images/favicon-512.png',
        'images/favicon-512-maskable.png',
        'images/favicon-512-rounded.png',
        'images/flag-br.png',
        'images/flag-de.png',
        'images/flag-es.png',
        'images/flag-fr.png',
        ...
        'images/icon-gear-32-dark.png',
        'images/icon-guest-32.webp',
