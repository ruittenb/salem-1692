...
let make = (
    ...
    let rulebookUrl = "doc/" ++ switch (gameState.language) {
        ...
        | #fr_FR => `Salem 1692 - Règles Français.docx`
        | #de_DE => "Salem 1692 - Spielregeln Deutsch.docx"
        | #nl_NL
    ...
    <div id="credits-page" className="page flex-vertical">
        ...
        <p>
            ...
            <Link href="https://facadegames.com/products/salem-1692" text="Salem 1692" /> spacedComma
            <Link href=rulebookUrl text={t("(Rulebook)")} /> spacedComma
