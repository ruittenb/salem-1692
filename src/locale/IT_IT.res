...
let table = Dict.fromArray([
  ...
  (
    ...
    `Ciò mantiene lo schermo attivo durante la notte, in modo che gli altri giocatori non possano vedere se hai utilizzato il tuo telefono.`,
  ),
  ...
  (
    ...
    `Nota bene! Da marzo 2025, questa app non sarà più scaricabile dal Google Play Store. Utilizza il link o il codice QR sopra.`,
  ),
  ("Credits", "Crediti"),
  ("Game:", "Gioco:"),
  ("Rulebook", "Regole"),
  ...
  ("Choose any other player to protect:", "Scegli un altro giocatore da proteggere:"),
  ...
  ("Residents of Salem,", "Cittadini di Salem,"),
  (
