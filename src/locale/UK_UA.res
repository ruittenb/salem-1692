...
let table = Dict.fromArray([
  ...
  (
    ...
    `Це зберігає екран активним протягом ночі, щоб інші гравці не могли бачити, чи користувалися ви смартфоном.`,
    //`Завдяки цьому екран не гасне під час Ночі, тож інші гравці не дізнаються, чи користувалися ви смартфоном.`,
  ),
  ...
  (
    ...
    `Зверніть увагу! З березня 2025 року цей додаток більше не можна буде завантажити з магазину Google Play. Будь ласка, скористайтеся посиланням або QR-кодом вище.`,
  ),
  ("Credits", `Кредити`),
  ("Game:", `Гра:`),
  ("Rulebook", `Правила`),
