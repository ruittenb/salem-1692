...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Nehmen Sie das andere Smartphone und schauen Sie in der App unter Einstellungen → ID des Spieles. Dann geben Sie hier die ID des Spieles ein.`),
    ("How many witches?", "Wie viele Hexen?"),
    ("Seating layout", "Sitzordnung"),
    ("It is possible to join this game from another smartphone.", `Es ist möglich an diesem Spiel teilzunehmen von einem anderen Smartphone aus.`),
    ("Take the other smartphone and look in the app under Join Game. Then enter the following Game ID there.", `Nehmen Sie das andere Smartphone und schauen Sie in der App unter Spiel beitreten. Dann geben Sie dort die folgende ID rein.`),
