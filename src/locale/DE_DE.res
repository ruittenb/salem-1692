...
let table = Js.Dict.fromArray([
    ...
    ("Connected.", "Verbunden."),
    ("It is possible to join a game running on another smartphone.", `Es ist möglich an einem Spiel beizutreten, das auf einem anderen Smartphone läuft.`),
    ...
    ("If you want to join a running game, you should stop hosting first.", `Wenn Sie einem laufenden Spiel beitreten möchten, müssen Sie zuerst das Hosten beenden.`),
