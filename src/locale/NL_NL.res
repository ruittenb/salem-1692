...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Neem de andere smartphone en kijk in de app onder Instellingen → Spel-ID. Voer deze dan hier in.`),
    ...
    ("Take the other smartphone and look in the app under Join Game. Then enter the following Game ID there.", "Neem de andere smartphone en kijk in de app onder Meespelen. Voer daar dit Spel-ID in."),
