...
let table = Js.Dict.fromArray([
    ...
    ("Game ID", "Spel-ID"),
    ("It is possible to join a game running on another telephone.", "Het is mogelijk mee te spelen met een spel dat op een andere telefoon draait."),
    (`Take the other telephone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Neem de andere telefoon en kijk in de app onder Instellingen → Spel-ID. Voer deze dan hier in.`),
