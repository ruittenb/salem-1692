...
let table = Dict.fromArray([
  ...
  (
    ...
    `Dit houdt het beeldscherm actief tijdens de nacht, zodat medespelers niet kunnen zien of je je telefoon gebruikt hebt.`,
  ),
  ...
  (
    ...
    "Let op! Vanaf maart 2025 is deze app niet meer downloadbaar van de Google Play Store. Gebruik a.u.b. de link of QR code hierboven.",
  ),
  ("Credits", "Credits"),
  ("Game:", "Spel:"),
  ("Rulebook", "Spelregels"),
  ...
  ("Choose any other player to protect:", "Kies een andere speler die beschermd moet worden:"),
  ...
  // Confess
  ("Confess", "Opbiechten"),
  ("Residents of Salem,", "Inwoners van Salem,"),
  (
