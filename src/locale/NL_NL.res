...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Multi-Telephone → Play as Host. Then enter the game code here.`, `Neem de andere smartphone en kijk in de app onder Multi-telefoon → Als gastheer spelen. Voer de spelcode dan hier in.`),
    ...
    (`Take the other smartphone and look in the app under Multi-Telephone → Play as Guest. Then enter the following game code there.`, `Neem de andere smartphone en kijk in de app onder Multi-telefoon → Als gast spelen. Voer daar deze spelcode in.`),
