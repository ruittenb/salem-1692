...
let table = Dict.fromArray([
  ...
  ("Speech", `Diálogo`),
  ("Music", `Música`),
  ("Stay active", `Mantén activo`),
  (
    "This keeps the screen active during the night, so that other players cannot see whether you used your phone.",
    `Esto mantiene la pantalla activa durante la noche, para que otros jugadores no puedan ver si usaste tu teléfono.`,
  ),
  ...
  (
    ...
    `¡Atención! A partir de marzo de 2025, esta aplicación ya no se podrá descargar desde Google Play Store. Utilice el enlace o el código QR que aparece más arriba.`,
  ),
  ("Credits", `Créditos`),
  ("Game:", "Juego:"),
  ...
  ("Residents of Salem,", "Ciudadanos de Salem,"),
  (
