...
let table = Js.Dict.fromArray([
    ...
    ("New Game Code", `Nuevo Código`),
    ("It is possible to join a game running on another smartphone.", `Es posible unirse a un juego en progreso en otro smartphone.`),
    (`Take the other smartphone and look in the app under Settings → Host Game. Then enter the game code here.`, `Tome el otro smartphone y busque en la aplicación en Configuración → Organizar. Luego ingrese el código aquí.`),
