...
let table = Js.Dict.fromArray([
    ...
    ("It is possible to join a game running on another telephone.", `Es posible unirse a un juego en progreso en otro teléfono.`),
    (`Take the other telephone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Tome el otro teléfono y busque en la aplicación en Configuración → ID del juego. Luego ingrese el ID del juego aquí.`),
