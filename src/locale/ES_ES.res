...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Multi-Telephone → Play as Host. Then enter the game code here.`, `Tome el otro smartphone y busque en la aplicación en Multi-teléfono → Jugar como anfitrión. Luego ingrese el código aquí.`),
