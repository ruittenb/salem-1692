...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Prenez l'autre smartphone et regardez dans l'application sous Configuration → ID du jeu. Puis, saisissez l'ID du jeu ici.`),
    ...
    ("Take the other smartphone and look in the app under Join Game. Then enter the following Game ID there.", `Prenez l'autre smartphone et regardez dans l'application sous Joindre un jeu. Puis, saisissez l'ID du jeu suivant là-bas.`),
