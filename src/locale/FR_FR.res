...
let table = Js.Dict.fromArray([
    ...
    ("Game ID", "ID du jeu"),
    ("It is possible to join a game running on another telephone.", `Il est possible de joindre un jeu en cours sur un autre téléphone.`),
    (`Take the other telephone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Prenez l'autre téléphone et regardez dans l'application sous Configuration → ID du jeu. Ensuite, saisissez l'ID du jeu ici.`),
