...
let table = Js.Dict.fromArray([
    ...
    ("During the night, player buttons will be shown in this order.", `Pendant la nuit, les boutons des joueurs seront affichés dans cet ordre.`),
    ("(add one)", "(ajouter)"),
    ...
    ("This affects the positioning of the player buttons at night.", `Cela affecte le positionnement des boutons des joueurs pendant la nuit.`),
    ("Language", "Langue"),
    ("English", "English"),
    ...
    (`Take the other smartphone and look in the app under Multi-Telephone → Play as Host. Then enter the game code here.`, `Prenez l'autre smartphone et regardez dans l'application sous Multi-téléphone → Jouer en tant qu'hôte. Puis, saisissez le code du jeu ici.`),
    ...
    (`Take the other smartphone and look in the app under Multi-Telephone → Play as Guest. Then enter the following game code there.`, `Prenez l'autre smartphone et regardez dans l'application sous Multi-téléphone → Jouer en tant qu'invité. Puis, saisissez le code du jeu suivant là-bas.`),
