...
let table = Js.Dict.fromArray([
  ...
  (
    "Click to show:",
    `Cliquez sur les boutons pour découvrir ce qui s'est passé pendant cette Nuit.`,
  ),
  ...
  ("Reveal constable's protection", `Révéler le protégé du Prévôt`),
