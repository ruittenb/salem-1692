...
let table = Js.Dict.fromArray([
    ...
    ("Game ID", "Game ID"),
    ("It is possible to join a game running on another telephone.", "It is possible to join a game running on another telephone."),
    (`Take the other telephone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Take the other telephone and look in the app under Settings → Game ID. Then enter the Game ID here.`),
