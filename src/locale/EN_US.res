...
let table = Js.Dict.fromArray([
    ...
    (`Take the other smartphone and look in the app under Settings → Game ID. Then enter the Game ID here.`, `Take the other smartphone and look in the app under Settings → Game ID. Then enter the Game ID here.`),
    ("It is possible to join this game from another smartphone.", "It is possible to join this game from another smartphone."),
    ("Take the other smartphone and look in the app under Join Game. Then enter the following Game ID there.", "Take the other smartphone and look in the app under Join Game. Then enter the following Game ID there."),
