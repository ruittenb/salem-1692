...
let table = Js.Dict.fromArray([
  ...
  // Day
  ("Daytime", `Um dia em Salém`),
  ("Dawn,", "O amanhecer,"),
  ("one witch", "um feiticeiro"),
  ("several witches", `vários feiticeiros`),
  ("Night,", "A noite,"),
  ("with constable", "com xerife"),
  ("without constable", "sem xerife"),
  ("Dawn, one witch", "O amanhecer, um feiticeiro"),
  ("Dawn, several witches", `O amanhecer, vários feiticeiros`),
  ("Night with constable", "Noite com xerife"),
  ("Night without constable", "Noite sem xerife"),
  ("Waiting for the host to announce nighttime...", `Esperando o anfitrião anunciar a noite...`),
  // Dawn / Night
  ("Dawn", "O amanhecer"),
  ("Night", "A noite"),
  ("The witches", "Os feiticeiros"),
  ("The witch's turn", "A vez do feiticeiro"),
  ("The witches' turn", "A vez dos feiticeiros"),
  ...
  ("Click to show:", `Descubram o que aconteceu enquanto vocês dormiam.`),
  ...
  ("The witches attacked-PRE", "Os feiticeiros atacaram"),
  ("The witches attacked-POST", ""),
  (" got the black cat", ` pegou o gato preto`), // contains nbsp
  ("Reveal constable's protection", `Revelar a proteção do xerife`),
  ("The constable protected-PRE", "O xerife protegeu"),
