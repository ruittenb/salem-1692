...
let table = Dict.fromArray([
  ...
  (
    ...
    `Atenção! A partir de março de 2025, este aplicativo não poderá mais ser baixado da Google Play Store. Use o link ou o código QR acima.`,
  ),
  ("Credits", `Créditos`),
  ("Game:", "Jogo:"),
  ...
  ("Choose any other player to protect:", "Escolha outro jogador para proteger:"),
  ...
  ("Nobody-SUBJ", `Ninguém`),
  ("nobody-OBJ", `ninguém`),
  ("The constable did not protect anybody", `O vigilante não protegeu ninguém`),
])
